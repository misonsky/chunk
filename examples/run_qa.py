...
from chnk import ChunkQuestionAnsweringTrainer,QuestionAnsweringTrainer,GetCallBack,normalize_chunk_args,apply_gradient_checkpointing_strategy,peft_function,rebuild_layer
...
def main():
    ...
    if model_args.chunk_tuning:
        trainer = ChunkQuestionAnsweringTrainer(
